...
Bab ini membahas tentang dasar teori yang akan digunakan dalam skripsi ini yang diambil dari dua sumber, yaitu ''KenKen Puzzle Solver using Backtracking Algorithm'' karya Asanilta Fahda \cite{Fahda:2015} dan ''Solving and Modeling Ken-ken Puzzle by Using Hybrid Genetics Algorithm'' karya Olivia Johanna, Samuel Lukas, dan Kie Van Ivanky Saputra \cite{JohannaLukasSaputra:2012}.

\section{Calcudoku \cite{Fahda:2015, JohannaLukasSaputra:2012}}
\label{sec:calcudoku}
...
\end{enumerate}
Jika operasi matematika yang ditentukan adalah pengurangan atau pembagian, maka ukuruan \textit{cage} harus berukuran dua sel. Pada beberapa versi dari teka-teki ini, hanya angka tujuan yang diberikan, dan pemain harus menebak operator dari setiap \textit{cage} untuk menyelesaikan teka-tekinya \cite{Fahda:2015, JohannaLukasSaputra:2012}.

\begin{figure}
\centering
\captionsetup{justification=centering}
\includegraphics[scale=1]{Gambar/Backtracking1}
\caption[Contoh permainan teka-teki Calcudoku dengan ukuran \textit{grid} \protect \begin{math}4 \times 4 \protect \end{math} yang belum diselesaikan. \protect \cite{Fahda:2015}]{Contoh permainan teka-teki dengan ukuran \textit{grid} \protect \begin{math}4 \times 4 \protect \end{math} yang belum diselesaikan. \protect \cite{Fahda:2015}}
...
\caption[Solusi untuk permainan teka-teki Calcudoku yang diberikan pada Gambar 2.1. \protect \cite{Fahda:2015}]{Solusi untuk permainan teka-teki Calcudoku yang diberikan pada Gambar 2.1. \protect \cite{Fahda:2015}}
...
\end{enumerate}
Menurut Johanna, Lukas, dan Saputra, tujuan dari teka-teki ini adalah untuk mencari nilai \begin{math}V(C_{b,k})\end{math} dan memenuhi persyaratan berikut \cite{JohannaLukasSaputra:2012}:
\begin{enumerate}
...
\section{Algoritma \textit{Backtracking} \cite{Fahda:2015}}
\label{sec:algoritmabacktracking}
...
Menurut Fahda, implementasi algoritma \textit{backtracking} memiliki beberapa sifat umum, yaitu \cite{Fahda:2015}:
\begin{enumerate}
...
\caption[Ilustrasi \textit{state space tree} yang digunakan dalam algoritma \protect \textit{backtracking} \protect \cite{Fahda:2015}]{Ilustrasi \textit{state space tree} yang digunakan dalam algoritma \protect \textit{backtracking} \protect \cite{Fahda:2015}}
\label{fig:backtracking3}
\end{figure}

Langkah-langkah dalam menggunakan \textit{state space tree} untuk mencari solusi adalah \cite{Fahda:2015}:
\begin{enumerate}
...
\caption[Contoh permainan teka-teki Calcudoku dengan ukuran \textit{grid} \protect \begin{math}3 \times 3\protect \end{math} \cite{Fahda:2015}]{Contoh permainan teka-teki Calcudoku dengan ukuran \textit{grid} \protect \begin{math}3 \times 3\protect \end{math} \protect \cite{Fahda:2015}}
...
\caption[Ilustrasi keadaan 3, 4, dan 5 pada sebuah \textit{grid} teka-teki Calcudoku \cite{Fahda:2015}]{Ilustrasi \textit{state} 3, 4, dan 5 pada sebuah \textit{grid} teka-teki Calcudoku \protect \cite{Fahda:2015}}
...
\caption[Ilustrasi keadaan 19 pada sebuah \textit{grid} teka-teki Calcudoku \cite{Fahda:2015}]{Ilustrasi keadaan 19 pada sebuah \textit{grid} teka-teki Calcudoku \protect \cite{Fahda:2015}}
...
\caption[Keadaan 25, simpul tujuan, sebagai hasil yang dicapai \protect \cite{Fahda:2015}]{Keadaan 25, simpul tujuan, sebagai hasil yang dicapai \protect \cite{Fahda:2015}}
...
\caption[\textit{state space tree} yang dikembangkan dalam proses menyelesaikan teka-teki Calcudoku yang digambarkan pada \protect Gambar~\ref{fig:backtracking4} \protect \cite{Fahda:2015}]{\textit{state space tree} yang dikembangkan dalam proses menyelesaikan teka-teki Calcudoku yang digambarkan pada \protect Gambar~\ref{fig:backtracking4} \protect \cite{Fahda:2015}}
...
Singkatnya, langkah-langkah dasar dari implementasi algoritma \textit{backtracking} dapat dijelaskan sebagai berikut \cite{Fahda:2015}:
\begin{enumerate}
...
\section{Algoritma \textit{Hybrid Genetic} \cite{JohannaLukasSaputra:2012}}
\label{sec:algoritmahybridgenetic}
...
Cara kerja algoritma genetik adalah sebagai berikut \cite{JohannaLukasSaputra:2012}:
\begin{enumerate}
...
Dalam proses reproduksi kawin silang, dua kromosom, yaitu kromosom orang tua, disilangkan untuk membuat dua kromosom yang baru, yaitu kromosom anak, dengan metodologi kawin silang \textit{\begin{math}N\end{math}-segments}. Gambar~\ref{fig:hybridgenetic9} menggambarkan contoh proses kawin silang antara dua kromosom.

\begin{figure}
\centering
\captionsetup{justification=centering}
\includegraphics[scale=1]{Gambar/HybridGenetic9}
\caption[Contoh proses kawin silang antara dua kromosom \cite{JohannaLukasSaputra:2012}]{Contoh proses kawin silang antara dua kromosom \protect \cite{JohannaLukasSaputra:2012}}
\label{fig:hybridgenetic9}
\end{figure}

Pertukaran mutasi digunakan untuk mendapatkan kemungkinan kromosom yang lain. Mutasi dilakukan di antara gen yang berada dalam segmen yang sama. Gambar~\ref{fig:hybridgenetic10} adalah contoh proses mutasi antara dua gen dalam segmen yang sama.

\begin{figure}
\centering
\captionsetup{justification=centering}
\includegraphics[scale=1]{Gambar/HybridGenetic10}
\caption[Contoh proses mutasi \cite{JohannaLukasSaputra:2012}]{Contoh proses mutasi \protect \cite{JohannaLukasSaputra:2012}}
\label{fig:hybridgenetic10}
\end{figure}

Cara kerja algoritma \textit{hybrid genetic} menurut Johanna, Lukas, dan Saputra adalah sebagai berikut \cite{JohannaLukasSaputra:2012}:
\begin{enumerate}
...
\end{enumerate}
Alur (\textit{flow chart}) penyelesaian permainan teka-teki Calcudoku dengan menggunakan algoritma \textit{hybrid genetic} dapat dilihat di Gambar~\ref{fig:hybridgenetic7}.

\begin{figure}
\centering
\captionsetup{justification=centering}
\includegraphics[scale=1]{Gambar/HybridGenetic7}
\caption[Alur penyelesaian permainan teka-teki Calcudoku dengan menggunakan algoritma \textit{hybrid genetic} \cite{JohannaLukasSaputra:2012}]{Alur penyelesaian permainan teka-teki Calcudoku dengan menggunakan algoritma \textit{hybrid genetic} \protect \cite{JohannaLukasSaputra:2012}}
\label{fig:hybridgenetic7}
\end{figure}