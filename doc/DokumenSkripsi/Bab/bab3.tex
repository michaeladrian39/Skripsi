...
Gambar~\ref{fig:sequencefileloadpuzzlefile} menunjukkan diagram \textit{sequence} saat \textit{file} permainan yang sudah dipilih dibuka.

\begin{figure}
\centering
\captionsetup{justification=centering}
\includegraphics[scale=0.3]{Gambar/Analisis/SequenceDiagramLoadPuzzleFile.png}
...
\centering
\captionsetup{justification=centering}
\includegraphics[scale=0.3]{Gambar/Analisis/SequenceDiagramReset.png}
...
\centering
\captionsetup{justification=centering}
\includegraphics[scale=0.3]{Gambar/Analisis/SequenceDiagramBacktracking.png}
