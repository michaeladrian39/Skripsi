...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{Calcudoku, algoritma \textit{backtracking}, algoritma \textit{hybrid genetic}, algoritma \textit{rule based}, algoritma genetik}
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\untuk{Skripsi ini dipersembahkan untuk Tuhan Yesus Kristus, keluarga, teman-teman, dan dosen-dosen Informatika Unpar}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\prakata{Segala puji dan syukur penulis ucapkan kepada Tuhan Yesus Kristus yang telah selalu menyertai, memberkati, dan memberikan rahmat-Nya, sehingga penulis dapat menyelesaikan skripsi ini dengan baik dan lancar. Terima kasih juga kepada orang-orang yang telah memberikan bantuan, doa, motivasi, dan dukungan kepada penulis selama penyelesaian skripsi ini. Penulis ingin berterima kasih kepada:

\begin{enumerate}
\item Tuhan Yesus Kristus, Tuhan yang sungguh luar biasa, karena Engkau saya akhirnya bisa lulus setelah 9 semester, penulis tidak akan mampu menyelesaikan skripsi ini tanpa Engkau.
\item Keluargaku, Papa, Mama, dan kedua adikku Chelsea Steffie Adriana dan Sheren Stella Adriana, terima kasih karena selalu mendukung saya dalam doa dan memotivasi saya dalam menyelesaikan skripsi ini.
\item Ibu Heni, sebagai pembimbing skripsi saya. Terima kasih banyak karena telah memberi bimbingan dan memberi banyak masukan dalam membuat skripsi ini.
\item Ibu Rosa dan Pak Claudio, sebagai penguji skripsi saya. Terima kasih juga karena telah memberikan banyak masukan dalam membuat skripsi ini.
\item Pak Husnul, sebagai dosen wali saya dari Semester 1 sampai dengan Semester 6.
\item Dosen-dosen Informatika Unpar lainnya: Ibu Mariskha, Ibu Vero, Pak Anung, Pak Pascal, Ibu Vania, Pak Chandra, Ibu Lucy, Pak Lionov, dan Pak Gede. Terima kasih karena telah mengajar saya dari Semester 1 sampai dengan Semester 8.
\item Warga Informatika Unpar yang sudah lulus dan sudah diwisuda sebelum saya lulus, terima kasih untuk saran-sarannya yang telah membantu penulis dan menulis skripsi ini.
\item Warga Informatika Unpar yang sudah lulus dan akan diwisuda bersama-sama dengan saya, selamat untuk kalian semua!
\item Warga Informatika Unpar yang lainnya, baik yang sedang berjuang menyelesaikan skripsi, maupun yang belum membuat skripsi. Semoga kalian juga berhasil menyelesaikan skripsi dan lulus!
\item Teman-teman saya di kebaktian Soli Deo Worship GII Hok Im Tong, terima kasih karena telah mendukung saya dalam doa sehingga saya bisa berhasil menyelesaikan skripsi ini.
\item Banyak pihak lainnya yang namanya tidak bisa disebutkan satu per satu.
\end{enumerate}

Penulis juga mohon maaf jika masih ada kekurangan dalam penulisan skripsi ini.} 
%=============================================================================
